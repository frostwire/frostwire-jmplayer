...
/* OpenHarmony headers are not available on non-OpenHarmony systems.
 * For audio-only builds, these decoders are not needed anyway.
 * This stub allows the build to proceed. */
...
#else
/* Stub definitions for non-OpenHarmony builds */
typedef void OH_AVBuffer;
typedef int OH_AVErrCode;
typedef int OH_AVPixelFormat;
#define OH_AVCODEC_MIMETYPE_VIDEO_AVC "video/avc"
#define OH_AVCODEC_MIMETYPE_VIDEO_HEVC "video/hevc"
#endif
