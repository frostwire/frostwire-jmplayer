...
CFLAGS   =   -D_ISOC99_SOURCE -I. -Iffmpeg -O2 -march=corei7-avx -pipe -fno-asynchronous-unwind-tables -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -mdynamic-no-pic  -fpie -DPIC  -I/usr/local/Cellar/gnutls/3.4.11/include -I/usr/local/Cellar/nettle/3.2/include -I/usr/local/Cellar/libtasn1/4.8/include -I/usr/X11/include -I/usr/local/Cellar/freetype/2.6.3/include/freetype2 -DZLIB_CONST
CXXFLAGS =   -D_ISOC99_SOURCE -I. -Iffmpeg -O2 -march=corei7-avx -pipe -fno-asynchronous-unwind-tables -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS -mdynamic-no-pic  -fpie -DPIC  -I/usr/local/Cellar/gnutls/3.4.11/include -I/usr/local/Cellar/nettle/3.2/include -I/usr/local/Cellar/libtasn1/4.8/include -I/usr/X11/include -I/usr/local/Cellar/freetype/2.6.3/include/freetype2 -DZLIB_CONST 
CC_DEPFLAGS = -MMD -MP
...
EXTRALIBS          =   -fpie -pie  -liconv -lncurses -L/usr/local/Cellar/gnutls/3.4.11/lib -lgnutls -framework CoreFoundation -framework VideoDecodeAcceleration -framework QuartzCore -lpng -lz -ljpeg -L/usr/local/Cellar/freetype/2.6.3/lib -lfreetype -lfontconfig  -lz -lbz2 -lxvidcore    -L/usr/X11R6/lib -lm  
EXTRALIBS_MPLAYER  =  -framework IOKit -framework Cocoa -lXext -lX11 -lXss -lXv -lXinerama -lXxf86vm -framework Carbon -framework Cocoa -framework QuartzCore -framework OpenGL -lGL -framework OpenAL -framework CoreAudio -framework AudioUnit -framework AudioToolbox -lx264 -lmp3lame
EXTRALIBS_MENCODER =  -lx264  -lmp3lame
